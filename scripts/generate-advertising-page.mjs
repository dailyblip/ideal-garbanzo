...
<header class="ad-sales-hero">
  ...
  <div class="ad-sales-proof"><span>${jobs.length} current jobs</span><span>${earlyCareer.length} early-career opportunities</span><span>${employers.size} employers represented</span><span>Employer-direct job links</span></div>
</header>

<section class="ad-sales-section">
  <span class="seo-kicker">AVAILABLE INVENTORY</span>
  <h2>Simple placements, not ad clutter.</h2>
  <div class="ad-inventory-grid">
    <article><h3>Homepage sponsorship</h3><p>A clearly labeled text sponsorship below the primary job-alert area. The approved homepage hero stays untouched.</p></article>
    <article><h3>Career-path sponsorship</h3><p>Contextual placement on jobs, apprenticeships, internships or career-event pages.</p></article>
    <article><h3>Regional sponsorship</h3><p>Campaigns can be limited to Northern Virginia / Mid-Atlantic, Texas, Southwest, Midwest, Southeast, Northeast or West pages.</p></article>
    <article><h3>Job-detail sponsorship</h3><p>Sitewide or campaign-specific messaging adjacent to job-detail content without changing employer listings or rankings.</p></article>
  </div>
</section>

<section class="ad-sales-section ad-sales-split">
...
<section class="ad-sales-section ad-standards">
  ...
  <p class="ad-legal-note">Advertisers remain responsible for their own federal, state and local campaign-finance, disclaimer, authorization and reporting obligations. Data Center Careers may require additional documentation or disclosure text before a political or issue-advocacy campaign is activated.</p>
</section>

<section class="ad-sales-section ad-lead-panel">
  ...
  <form action="https://buttondown.com/api/emails/embed-subscribe/datacentercareers" method="post" class="ad-lead-form">
    <label><span>Email address</span><input type="email" name="email" autocomplete="email" required placeholder="you@organization.org"></label>
