...
const directRolePatterns = new Map([
  ...
  ['Vantage Data Centers', /^\/en-US\/Vantage\/job\/[^/]+\/[^/]+\/?$/i],
  ['QTS Data Centers', /^\/en-US\/QTS\/job\/[^/]+\/[^/]+\/?$/i],
  ['CyrusOne', /^\/en-US\/CyrusOneCareerPortal\/job\/[^/]+\/[^/]+\/?$/i],
  ['STACK Infrastructure', /^\/en-US\/STACK_AMER\/job\/[^/]+\/[^/]+\/?$/i],
  ['NTT Global Data Centers', /^\/en-US\/External\/job\/[^/]+\/[^/]+\/?$/i],
  ['Aligned Data Centers', /^\/en-US\/aligneddc\/job\/[^/]+\/[^/]+\/?$/i],
  ['CoreSite', /^\/jobs\/\d+(?:[-/]|$)/i],
  ['Iron Mountain', /\/job\//i],
...
const regressionCases = [
  ...
  ['Vantage Data Centers', 'https://vantagedc.wd1.myworkdayjobs.com/en-US/WrongSite/job/San-Antonio-Texas/Critical-Facilities-Engineer--NA_R24063', false],
  ['QTS Data Centers', 'https://qtsdatacenters.wd5.myworkdayjobs.com/en-US/QTS/job/Richmond-VA/Site-Services-Technician-I_R2026-1994-1', true],
  ['QTS Data Centers', 'https://qtsdatacenters.wd5.myworkdayjobs.com/en-US/QTS', false],
  ['QTS Data Centers', 'https://qtsdatacenters.wd5.myworkdayjobs.com/en-US/WrongSite/job/Richmond-VA/Site-Services-Technician-I_R2026-1994-1', false],
  ['CyrusOne', 'https://cyrusone.wd1.myworkdayjobs.com/en-US/CyrusOneCareerPortal/job/New-Albany-OH/Critical-Environments-Operator-II_R0008016', true],
  ['CyrusOne', 'https://cyrusone.wd1.myworkdayjobs.com/en-US/CyrusOneCareerPortal', false],
  ['CyrusOne', 'https://cyrusone.wd1.myworkdayjobs.com/en-US/WrongSite/job/New-Albany-OH/Critical-Environments-Operator-II_R0008016', false],
  ['STACK Infrastructure', 'https://stackinfra.wd108.myworkdayjobs.com/en-US/STACK_AMER/job/Santa-Teresa-NM/Critical-Operations-Technician_JR00150', true],
  ['STACK Infrastructure', 'https://stackinfra.wd108.myworkdayjobs.com/en-US/STACK_AMER', false],
  ['STACK Infrastructure', 'https://stackinfra.wd108.myworkdayjobs.com/en-US/WrongSite/job/Santa-Teresa-NM/Critical-Operations-Technician_JR00150', false],
  ['NTT Global Data Centers', 'https://nttglobaldatacenters.wd501.myworkdayjobs.com/en-US/External/job/Sacramento-CA/XMLNAME-1012---Data-Center-Technician-L1_JR101974', true],
  ['NTT Global Data Centers', 'https://nttglobaldatacenters.wd501.myworkdayjobs.com/en-US/External', false],
  ['NTT Global Data Centers', 'https://nttglobaldatacenters.wd501.myworkdayjobs.com/en-US/WrongSite/job/Sacramento-CA/XMLNAME-1012---Data-Center-Technician-L1_JR101974', false],
  ['Aligned Data Centers', 'https://aligneddc.wd12.myworkdayjobs.com/en-US/aligneddc/job/DFW-04/Critical-Facilities-Technician_JR101068', true],
  ['Aligned Data Centers', 'https://aligneddc.wd12.myworkdayjobs.com/en-US/aligneddc', false],
  ['Aligned Data Centers', 'https://aligneddc.wd12.myworkdayjobs.com/en-US/WrongSite/job/DFW-04/Critical-Facilities-Technician_JR101068', false],
